...
const SelectServiceForGroomComponent = () => {
  ...
  const handleNavigation = () => {
    navigation.navigate('GroomingInnerScreen', {selectedService});
  };
          ...
          <View style={styles.bookingDateContainer}>
            ...
            {ServicesCare.map(service => (
              <TouchableOpacity
                ...
                <View style={{width: '75%', gap: SIZES.width * 0.01}}>
...
export default SelectServiceForGroomComponent;
